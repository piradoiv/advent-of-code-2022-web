...
#tag Events MainToolbar
	#tag Event
		Sub Opening()
		  ...
		  "Distress Signal", "Regolith Reservoir")
	...
	#tag Event
		Sub MenuSelected(Item as WebToolbarButton, hitItem as WebMenuItem)
		  Pages.SelectedPanelIndex = hitItem.Tag.IntegerValue
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events Pages
