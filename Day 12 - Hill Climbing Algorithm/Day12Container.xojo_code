...
Begin WebContainer Day12Container
   Compatibility   =   ""
   ControlID       =   ""
   Enabled         =   True
   Height          =   486
   ...
   Begin PuzzleInputWebDialog PuzzleInputDialog
      ...
      _mPanelIndex    =   -1
   End
   Begin Day12WebThread PuzzleThread
      DebugIdentifier =   ""
      Index           =   -2147483648
      InputValue      =   ""
      Left            =   0.0
	...
	#tag Event
		Sub UserInterfaceUpdate(data() as Dictionary)
		  For Each current As Dictionary In data
		    ...
		    Case "path"
		      Label1.Text = current.Value("path").StringValue
		    Case "finish"
